...
import org.eclipse.gmf.varbox.database.database.DatabaseFactory;
import org.eclipse.gmf.varbox.database.database.DatabasePackage;
import org.eclipse.gmf.varbox.database.database.ForeignKey;
import org.eclipse.gmf.varbox.database.database.NotNull;
import org.eclipse.gmf.varbox.database.database.PrimaryKey;
import org.eclipse.gmf.varbox.database.database.Scheme;
import org.eclipse.gmf.varbox.database.database.Table;

import org.eclipse.gmf.varbox.database.database.util.DatabaseValidator;
...
public class DatabasePackageImpl extends EPackageImpl implements DatabasePackage {
	 ...
	 * @see org.eclipse.gmf.varbox.database.database.DatabasePackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public EReference getTable_Notnull() {
	...
	public void createPackageContents() {
		...
		createEReference(tableEClass, TABLE__NOTNULL);
	...
	public void initializePackageContents() {
		...
		initEReference(getTable_Notnull(), this.getNotNull(), null, "notnull", null, 0, -1, Table.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
	...
	protected void createEcoreAnnotations() {
		...
		addAnnotation
		  (tableEClass, 
		   source, 
		   new String[] {
			 "constraints", "uniqueColumnName uniquePrimaryKey"
		   });	
	}
		...
		addAnnotation
		  (tableEClass, 
		   ...
		   new String[] {
			 ...
			 "uniquePrimaryKey", "primary->size() = 1"
		   });
	}
